...
import { getAllFoodItems, addFoodItem, updateFoodItem, deleteFoodItem, setItemAvailability } from '../api/foodApi';
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            if (editItem) {
                ...
                await addFoodItem({ ...formData, canteen: canteen._id });
            }
            // Refresh list
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {showForm && (
                    <div className="relative group animate-in fade-in slide-in-from-top-4 duration-500">
                        ...
                        <Card title={editItem ? "Edit Food Item" : "Add New Food Item"} subtitle="Fill item details">
                            <form onSubmit={handleFormSubmit} className="space-y-4">
                                ...
                                <div className="flex gap-3 justify-end pt-4 border-t border-slate-800">
                                    <button type="button" onClick={closeForm} className="px-5 py-2 rounded-xl text-slate-400 hover:text-white transition">Cancel</button>
                                    <button type="submit" className="px-5 py-2 rounded-xl bg-emerald-500 text-slate-950 font-bold hover:bg-emerald-400 transition shadow-lg shadow-emerald-500/20">
                                        {editItem ? "Save Changes" : "Confirm & Add"}
                                    </button>
                                </div>
                            </form>
                        </Card>
