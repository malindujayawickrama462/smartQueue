  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card title="Create Admin" subtitle="Create new admin accounts.">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      <div className="text-right">
                        ...
                        <div className="text-xs text-purple-400">{u.role}</div>
                      </div>
                      <button
                        ...
                        title={u._id === user?._id ? "Can't delete yourself" : 'Delete admin'}
                      >
                        Delete
                      </button>
                    </div>
